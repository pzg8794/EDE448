...
- Source PDF: `modules/Module2/Read/Goldstein (2013) Peer Support.pdf`
- Local converted Markdown: `local-derived/pdf-markdown/modules/Module2/Read/Goldstein (2013) Peer Support.md`
...
Peer support and classroom belonging.

## Main Ideas

This source focuses on peer support as part of classroom social architecture. It is important because peers can either expand or block access for students with autism and complex needs.

- Access includes social access, not only instructional access.
- Identity and healing matter when students are not isolated as problems to manage.
- Agency grows when peer systems allow students to contribute, help, and be helped.
...
Use this source for Kit for Kids connections and positive support planning.
