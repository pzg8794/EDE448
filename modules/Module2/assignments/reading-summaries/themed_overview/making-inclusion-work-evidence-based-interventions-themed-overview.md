# Making Inclusion Work - Evidence-Based Interventions - Themed Overview

## Source Location

- Source PDF: `modules/Module2/Read/Making_Inclusion_Work_for_Students_with_Autism_Spe..._----_(Chapter_2--Evidence-Based_Interventions_and_Supported_Inclusion_of_Stu...).pdf`
- Local converted Markdown: `local-derived/pdf-markdown/modules/Module2/Read/Making_Inclusion_Work_for_Students_with_Autism_Spe..._----_(Chapter_2--Evidence-Based_Interventions_and_Supported_Inclusion_of_Stu...).md`
- Module: Module 2: Supporting Students with Prosocial Norms in School-Based Settings

## Source Purpose

Evidence-based supported inclusion.

## Main Ideas

This chapter connects inclusion with evidence-based interventions and support. It helps teachers avoid unsupported or purely intuitive plans.

- Evidence should serve access, not replace human interpretation.
- EQUITAS asks whether the intervention fits the student and context.
- Transformation happens when inclusion is built with supports that make participation real.
...
Use this to justify specific support strategies in the support plan.
