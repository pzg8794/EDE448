# Autism Spectrum Disorder - School-Centered Interventions - Themed Overview

## Source Location

- Source PDF: `modules/Module2/Read/Autism_spectrum_disorder.pdf`
- Local converted Markdown: `local-derived/pdf-markdown/modules/Module2/Read/Autism_spectrum_disorder.md`
- Module: Module 2: Supporting Students with Prosocial Norms in School-Based Settings

## Source Purpose

School-centered autism intervention overview.

## Main Ideas

This source frames autism through school-based supports and intervention planning. It helps connect student needs to classroom systems.

- Access means interventions must reduce barriers rather than simply normalize behavior.
- EQUITAS asks which student profile the school expects and what happens when students communicate differently.
- The Puzzle Plan link is evidence: schools need better data about context, not just behavior counts.
...
Use this as background for positive support planning.
