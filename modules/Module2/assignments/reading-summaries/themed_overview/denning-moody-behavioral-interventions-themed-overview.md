# Denning and Moody - Behavioral Interventions - Themed Overview

## Source Location

- Source PDF: `modules/Module2/Read/Inclusion_and_Autism_Spectrum_Disorder_Proactive_S..._----_(6._Behavioral_Interventions).pdf`
- Local converted Markdown: `local-derived/pdf-markdown/modules/Module2/Read/Inclusion_and_Autism_Spectrum_Disorder_Proactive_S..._----_(6._Behavioral_Interventions).md`
...
This chapter connects autism inclusion to proactive behavioral interventions. It is useful for moving support planning upstream.

- Proactive support is an access practice: design before escalation.
- Dignity means interventions should teach and support rather than publicly shame.
- Neurodiversity asks whether the intervention respects different regulation and communication styles.
...
Use this source to support the positive classroom support plan.
