# Leach Excerpt - Themed Overview

## Source Location

- Source PDF: `modules/Module2/Read/Leach_excerpt.pdf`
- Local converted Markdown: `local-derived/pdf-markdown/modules/Module2/Read/Leach_excerpt.md`
- Module: Module 2: Supporting Students with Prosocial Norms in School-Based Settings

## Source Purpose

Practical inclusion/support excerpt.

## Main Ideas

This excerpt contributes practical thinking about supporting students with autism or complex needs in classroom settings.

- The source can help translate theory into teacher moves.
- Access requires visible routines, clear expectations, and responsive support.
- The theme connection is avoiding generic management and asking what design change would help.
...
Use this as a supporting source when you need a practical classroom example.
