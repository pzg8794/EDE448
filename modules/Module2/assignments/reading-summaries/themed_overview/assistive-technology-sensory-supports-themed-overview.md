# AT Sensory Supports - Themed Overview

## Source Location

- Source PDF: `modules/Module2/Read/at_sensory_supports.pdf`
- Local converted Markdown: `local-derived/pdf-markdown/modules/Module2/Read/at_sensory_supports.md`
...
This source focuses on sensory supports and/or assistive technology. It is useful for connecting behavior support to bodymind access.

- Sensory support is not a reward; it is access infrastructure.
- EQUITAS asks whether the classroom assumes one body, pace, noise tolerance, and attention style.
- Joy and healing appear when students can regulate without shame.
...
Use this for sensory walk, classroom support, and portfolio resources.
