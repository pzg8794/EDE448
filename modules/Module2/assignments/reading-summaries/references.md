# Module 2 References and Source Trail
...
Edutopia. (n.d.). *Edutopia sessions: Classroom management for new teachers* [Webinar].

Jorgensen, C. M. (2018). Facilitate reciprocal social relationships. In *It's more than "just being in": Creating authentic inclusion for students with complex support needs*. Paul H. Brookes Publishing.
...
## Verified Public PTR Metadata

- [Brookes Publishing PTR product page](https://products.brookespublishing.com/Prevent-Teach-Reinforce-P1085.aspx): confirms the 2019 second edition, six authors, five-step process, and Appendix 4.1 title.
- [PTR forms and tools](https://www.delawarepbs.org/wp-content/uploads/2019/10/Handouts-Combined.pdf): publicly accessible 2019 forms used only to verify the Appendix 4.1 fields. The copyrighted form itself is not reproduced in this public repository.

## Local Course Sources

- Syllabus: `Summer 2026 EDE 448 /Communication and Behavior Syllabus.docx`
- Module guide: `modules/Module2/Quick Guide for Module.pdf`
- PTR directions: `modules/Module2/assignments/Prevent Teach Reinforce Planning.pdf`
- Support-plan directions: `modules/Module2/assignments/Positive Classroom Support Plan.pdf`
- Blackboard journal prompt: `modules/Module2/assignments/Module2 Journal.png`
- Blackboard discussions: `modules/Module2/assignments/What do you know?.png` and `modules/Module2/assignments/Takeaways.png`
- Course readings and media under `modules/Module2/Read/` and `modules/Module2/Media/`
- Local-only searchable conversions under `local-derived/pdf-markdown/modules/Module2/`
...
The placement and camp records support reflection on instructional design. They do not establish a student's diagnosis, internal state, or behavioral function. The drafts use non-identifying descriptions and mark interpretations as tentative when the evidence does not support certainty.
