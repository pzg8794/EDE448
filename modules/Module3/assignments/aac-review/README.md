...
Research one AAC device or tool, summarize it, review its communication benefits and challenges, include a visual when possible, post the review, and reply to a classmate. The local Blackboard capture states that there is no minimum word count.

- **Blackboard:** [open the EDE448 course outline and select Module 3 > AAC Review](https://learn.rochester.edu/ultra/courses/_113760_1/outline?courseId=_113760_1)
- **Due:** August 10, 2026, 11:59 PM EDT
- **Points:** 5
- **Local prompt evidence:** `modules/Module3/assignments/AAC Review (Class Discussion).png`
- **Submission state:** review draft only; nothing has been posted
