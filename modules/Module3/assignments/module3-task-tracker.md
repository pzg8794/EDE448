...
The local Blackboard captures show **August 10, 2026, 11:59 PM EDT** for AAC Review and Journal #3. Finish by August 7 if graduating this term. The TD Snap AAC Review was posted August 9 and edited at 5:02 PM EDT. Its required classmate reply and all other Module 3 posts/submissions remain pending unless Piter records otherwise.
...
| Takeaways | Submission-ready personalized draft; not posted | [Prompt and response](discussions/README.md#takeaways) | Review voice, post manually, and record completion |

## Portfolio Harvest

| Resource | Assignment Source | State |
| --- | --- | --- |
| AAC Tool Review for Teacher/Family Decision-Making | AAC Review | Posted; peer reply pending |
