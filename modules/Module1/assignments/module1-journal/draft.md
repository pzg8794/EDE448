# Module 1 Journal: Understanding Developmental Differences

## Blackboard Prompt

Due: July 15, 2026, 11:59 PM EDT

Respond after completing the READ and MEDIA requirements:

> How does the world come to understand developmental differences?

## Completed Source Set

- Cole and Telesford (2023), *Autism*
- Ortega (2013), *Cerebralizing Autism within the Neurodiversity Movement*, from Davidson and Orsini's *Worlds of Autism*
- National Education Association (2020), *Teaching Students with Autism: A Guide for Educators*
- Media: *Autism: Insight from Inside* (Infobase, 2016)

## Ready-To-Submit Response

### Who Gets to Name, Interpret, and Design?

#### What I noticed before I had the language
...
#### When a label opens a door--and when it starts closing one
...
The strongest question I can ask is not, "How do I stop this behavior?" It is, "What might this student be communicating, and what barrier is present?" That change in language changes the intervention. It moves me away from controlling the student and toward redesigning the conditions.
...
#### Why credibility, culture, and identity cannot be separated
...
#### Designing better evidence through the Puzzle Plan and EQUITAS
...
- Local media transcript: `modules/Module1/Media/Autism-Insight_from Inside-en_128513.txt`
- Local course-reading Markdown conversions under `local-derived/pdf-markdown/modules/Module1/Read/` for source verification only; copyrighted extracted text is not published
...
- [x] Uses three READ sources and one MEDIA source
- [x] Embeds teaching and lived experience throughout the source analysis
- [x] Connects diagnosis, neurodiversity, identity, media, and education
- [x] Uses non-identifying evidence from teaching practice
- [x] Includes neurodivergence and multiple identities without assigning diagnoses to students
- [x] Connects the reflection to the Puzzle Plan and EDE448 access-to-agency theme
- [x] Completed a final personal voice and warmth check

## Optional AI-Use Note

> I used a generative AI tool to help organize course readings, media notes, and non-identifying TeachingPlacement evidence into a journal draft. I reviewed the sources, selected the claims and teaching connections, revised the response, and take responsibility for the submitted work.
