# NEA Guide - Teaching Students with Autism - Themed Overview

## Source Location

- Source PDF: `modules/Module1/Read/NEA Guide_ Teaching Students with Autism.pdf`
- Local converted Markdown: `local-derived/pdf-markdown/modules/Module1/Read/NEA Guide_ Teaching Students with Autism.md`
- Module: Module 1: Introduction to Autism and Other Complex Support Needs

## Source Purpose

Practical educator guide.

## Main Ideas

The NEA guide is a broad practical source for teachers. It helps translate autism awareness into classroom supports, collaboration, and inclusive routines.

- It is useful for access because it names concrete design moves teachers can make.
- It should be read critically so support does not become one-size-fits-all.
- The EQUITAS question is whether the guide helps teachers redesign the environment, not just manage the student.
...
Use this as a practical source for the Sensory Walk, Kit for Kids, and portfolio work.
