# Davidson (2013) - Neurodiversity Movement - Themed Overview

## Source Location

- Source PDF: `modules/Module1/Read/Davidson (2013) Neurdiversity Movement.pdf`
- Local converted Markdown: `local-derived/pdf-markdown/modules/Module1/Read/Davidson (2013) Neurdiversity Movement.md`
- Module: Module 1: Introduction to Autism and Other Complex Support Needs

## Source Purpose

Neurodiversity movement and identity.

## Main Ideas

This reading frames neurodiversity as a movement, not just a vocabulary word. It helps explain why autistic self-advocacy, identity, and community matter in education.

- Neurodiversity pushes against shame, masking, and deficit-only intervention.
- Agency means autistic people participate in defining what support should mean.
- EQUITAS asks whether classrooms assume neurotypical communication, pacing, attention, and social behavior as default.
...
Use this source to connect autism support with identity, pride, and self-advocacy.
