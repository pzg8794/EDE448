# Bock, Borders, and Probst - Inclusion of Students with ASD - Themed Overview

## Source Location

- Source PDF: `modules/Module1/Read/General_and_Special_Education_Inclusion_in_an_Age_..._----_(Inclusion_of_Students_with_Autism_Spectrum_Disorders).pdf`
- Local converted Markdown: `local-derived/pdf-markdown/modules/Module1/Read/General_and_Special_Education_Inclusion_in_an_Age_..._----_(Inclusion_of_Students_with_Autism_Spectrum_Disorders).md`
- Module: Module 1: Introduction to Autism and Other Complex Support Needs

## Source Purpose

General/special education inclusion.

## Main Ideas

This chapter addresses inclusion of students with autism across general and special education. It is useful for distinguishing physical placement from meaningful participation.

- Access is more than being in the room; students need participation, supports, and belonging.
- EQUITAS asks whether inclusive settings are built around real support or symbolic placement.
- Criticality means asking which students are included only conditionally, after they prove they can fit.
...
Use this source to argue that inclusion must be structured, supported, and accountable.
