# Davidson (2013) - Critical Autism Studies - Themed Overview

## Source Location

- Source PDF: `modules/Module1/Read/Davidson (2013) Critical Autism Studies.pdf`
- Local converted Markdown: `local-derived/pdf-markdown/modules/Module1/Read/Davidson (2013) Critical Autism Studies.md`
- Module: Module 1: Introduction to Autism and Other Complex Support Needs

## Source Purpose

Critical autism studies frame.

## Main Ideas

This source challenges deficit-only and medicalized understandings of autism. It asks readers to consider autistic voices, social power, representation, identity, and the politics of who gets to define autism.

- It is one of the strongest Module 1 sources for criticality and identity.
- It shifts autism from an individual defect frame toward a social, cultural, and political frame.
- It supports the EDU498-style theme by asking how institutions misread students and how classrooms can interrupt that harm.
...
Use this source to keep Module 1 from becoming a generic diagnostic overview.
