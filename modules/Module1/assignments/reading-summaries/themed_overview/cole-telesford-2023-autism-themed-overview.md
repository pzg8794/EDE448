# Cole and Telesford (2023) - Autism - Themed Overview

## Source Location

- Source PDF: `modules/Module1/Read/Cole (2023) Autism.pdf`
- Local converted Markdown: `local-derived/pdf-markdown/modules/Module1/Read/Cole (2023) Autism.md`
- Module: Module 1: Introduction to Autism and Other Complex Support Needs

## Source Purpose

Professional overview for educators and service providers.

## Main Ideas

Cole and Telesford provide a concise educator/service-provider overview of autism. The reading helps define autism-related characteristics and connect them to school-based support needs.

- It gives a shared professional foundation for recognizing autism in educational settings.
- The Puzzle Plan connection is evidence quality: teachers need to gather context, not just symptoms.
- The EQUITAS connection is support design: identification should lead to access, not lowered expectations.
...
Use this as one of the strongest Module 1 anchor readings for diagnostic and educator vocabulary.
