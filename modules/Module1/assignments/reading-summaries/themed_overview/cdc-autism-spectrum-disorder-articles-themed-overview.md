# Autism Spectrum Disorder Articles - CDC - Themed Overview

## Source Location

- Source PDF: `modules/Module1/Read/Autism Spectrum Disorder Articles _ Autism Spectrum Disorder (ASD) _ CDC.pdf`
- Local converted Markdown: `local-derived/pdf-markdown/modules/Module1/Read/Autism Spectrum Disorder Articles _ Autism Spectrum Disorder (ASD) _ CDC.md`
- Module: Module 1: Introduction to Autism and Other Complex Support Needs

## Source Purpose

Public health and diagnostic overview.

## Main Ideas

This source gives a broad public-health overview of autism spectrum disorder, including identification, developmental signs, and general information for families and educators.

- It supports diagnostic literacy: teachers need enough shared language to recognize autism-related support needs.
- A public-health frame can open access to services, but it can also flatten autistic identity if it becomes the only lens.
- The Puzzle Plan move is to use diagnostic information as access evidence, not as a total description of the student.
...
Use the CDC framing for shared vocabulary, then deepen it with lived-experience and classroom-design sources.
