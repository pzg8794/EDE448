# Autism Spectrum Disorder - Reading Rockets - Themed Overview

## Source Location

- Source PDF: `modules/Module1/Read/Autism Spectrum Disorder _ Reading Rockets.pdf`
- Local converted Markdown: `local-derived/pdf-markdown/modules/Module1/Read/Autism Spectrum Disorder _ Reading Rockets.md`
- Module: Module 1: Introduction to Autism and Other Complex Support Needs

## Source Purpose

Educator-facing overview.

## Main Ideas

This source translates autism information into a school/literacy context. It is useful for teachers who need to connect autism knowledge to classroom routines, reading, communication, and support.

- It treats teachers as access designers, not just observers of disability.
- It helps connect literacy and communication: students may need multiple ways to understand text, directions, social expectations, and classroom language.
- It can support healing when teachers stop interpreting difference as unwillingness.
...
Use this source to connect autism knowledge to literacy access and classroom design.
