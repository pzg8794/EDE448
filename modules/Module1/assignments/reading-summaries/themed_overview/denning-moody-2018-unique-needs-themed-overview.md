# Denning and Moody (2018) - Unique Needs and Autism - Themed Overview

## Source Location

- Source PDF: `modules/Module1/Read/Denning Unique (2018) Needs and Autism.pdf`
- Local converted Markdown: `local-derived/pdf-markdown/modules/Module1/Read/Denning Unique (2018) Needs and Autism.md`
- Module: Module 1: Introduction to Autism and Other Complex Support Needs

## Source Purpose

Practical inclusion and support needs.

## Main Ideas

Denning and Moody focus on the unique support needs of students with autism in inclusive settings. The reading helps connect knowledge about autism to proactive classroom support.

- Access depends on matching support to the learner instead of expecting the learner to fit a fixed classroom script.
- The healing dimension is avoiding blame when a student needs different routines, sensory supports, or communication pathways.
- Transformation happens when support needs are treated as design information.
...
Use this for practical assignment language about classroom supports and individualized access.
