# Smith (2011) - Making Inclusion Work - Themed Overview

## Source Location

- Source PDF: `modules/Module1/Read/Smith (2011) Making Inclusion Work.pdf`
- Local converted Markdown: `local-derived/pdf-markdown/modules/Module1/Read/Smith (2011) Making Inclusion Work.md`
- Module: Module 1: Introduction to Autism and Other Complex Support Needs

## Source Purpose

Evidence-based inclusion guide.

## Main Ideas

Smith focuses on making inclusion workable for students with autism through evidence-based strategies and classroom planning.

- Inclusion requires deliberate design, not good intentions alone.
- Agency is supported when students have real participation pathways and not only adult-managed accommodation.
- The source connects to transformation because it treats inclusion as something teachers can build.
...
Use this source to strengthen claims about supported inclusion and classroom planning.
