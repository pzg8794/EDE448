# Autism Spectrum Disorder - General Overview - Themed Overview

## Source Location

- Source PDF: `modules/Module1/Read/autism-spectrum-disorder.pdf`
- Local converted Markdown: `local-derived/pdf-markdown/modules/Module1/Read/autism-spectrum-disorder.md`
- Module: Module 1: Introduction to Autism and Other Complex Support Needs

## Source Purpose

General autism overview.

## Main Ideas

This source provides another general overview of autism spectrum disorder. It can help triangulate common definitions, characteristics, and support language.

- General overviews are useful starting points but should not become the whole story.
- The course theme asks us to move from description to access design.
- Criticality means comparing what institutional sources notice with what autistic people and families notice.
...
Use this source as background, then pair it with critical autism and neurodiversity readings.
