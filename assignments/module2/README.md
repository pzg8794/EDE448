# Module 2: Supporting Students With Prosocial Norms in School-Based Settings
...
- Read three texts.
- Include at least one chapter and the resources from Dunlap et al.'s required PTR text.
- Engage with one media source if useful; the quick guide marks media optional.
- Complete the Module 2 journal.
- Complete Prevent-Teach-Reinforce Planning.
...
| [Module #2 Journal](https://learn.rochester.edu/ultra/courses/_113760_1/outline/journal/_9485976_1?courseId=_113760_1) | July 31, 2026, 11:59 PM EDT | **Almost ready, not submitted:** [authorized GitHub/Overleaf working repository](https://github.com/pzg8794/EDE448-Module2_Journal) with complete Markdown and LaTeX review materials |
...
- [Reading and media summaries](reading-summaries/README.md)
...
All Module 2 responses use one coherent argument:

> Positive support must be judged by what it gives a student, not only by what it stops. Prevention, teaching, reinforcement, communication, relationships, sensory access, and data should increase dignity, consent, neurodiversity, agency, belonging, and rigorous participation rather than enforce masking or quiet compliance.

## Final Human Review

Piter still needs to:
