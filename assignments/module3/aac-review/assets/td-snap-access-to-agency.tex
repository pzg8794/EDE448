...
\node[support] (preference) at (1.55,-0.02) {Communicator preference and consent};
\node[support, right=0.30cm of preference] (identity) {Identity, culture, and bilingual language};
\node[support, right=0.30cm of identity] (backup) {Reliable low-tech backup};
\node[support, right=0.30cm of backup] (training) {Partner training and technical support};
...
\node[draw=MidTeal, rounded corners=5pt, fit=(preference)(identity)(backup)(training),
  inner sep=8pt] {};
