...
The local Blackboard capture for Journal #3 says that the instructor has not added a separate prompt. The review draft therefore responds to the module's essential question: **What does meaningful communication look like for students with complex needs?**
...
- **Points:** 10
- **Local prompt evidence:** `Module3/assignments/Journal_3.png`
